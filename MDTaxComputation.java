...
public class MDTaxComputation extends TaxComputationMethod {
  private static double MDTaxRate = .05;
  private ArrayList<ReceiptDate> holidays;      //All the states tax holidays are stored in a array list of receiptdates
  private String state_code = "MD";             //Added state code to make it easier to find tax classes
  ...
  public double computeTax(PurchasedItems items, ReceiptDate date) {
    if(taxHoliday(date)==true)
      return 0.00;
       ...
       return MDTaxRate*items.getTotalCost();
  }
